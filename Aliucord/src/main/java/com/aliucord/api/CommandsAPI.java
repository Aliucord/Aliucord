...
public class CommandsAPI {
    ...
    public static ApplicationCommandOption messageOption =
            new ApplicationCommandOption(ApplicationCommandType.STRING, "message", null, R.g.command_shrug_message_description, false, false, null, null, null);
    /** Required CommandOption of type String */
    public static ApplicationCommandOption requiredMessageOption =
            new ApplicationCommandOption(ApplicationCommandType.STRING, "message", null, R.g.command_shrug_message_description, true, false, null, null, null);
