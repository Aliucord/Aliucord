...
public class R$h {
    ...
    public static int UiKit_Settings_Item_Icon = 0;
    public static int UiKit_Settings_Item_Label = 0;
    public static int UiKit_Settings_Item_SubText = 0;
    public static int UiKit_TextAppearance = 0;
